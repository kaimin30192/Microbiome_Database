...
count <- read.table("G_count.csv", row.names = 1, sep="\t", header=T)
taxa <- read.table("G_taxa.csv", row.names = 1, sep="\t", header=T)
sample_info <- read.csv("G_info.csv", row.names = 1)
