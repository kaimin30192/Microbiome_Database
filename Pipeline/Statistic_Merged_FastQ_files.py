...
# Date : 2020/10/11
# Author : Kaimin
# description : This is a program to check reads numbers in the FastQ file of Merged data.

# Target the file
import glob
import numpy as np
targetPattern = r"Merged_*.fastq" 
...
print(">>> After Pair end Merged <<<", file=data)
