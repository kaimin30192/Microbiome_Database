...
# Date : 2020/10/11
# Author : Kaimin
# description : This is a program to check reads numbers in the FastQ file After N-base filtering.

# List the files
import glob
import numpy as np
targetPattern_1 = r"dN*_1.fastq" 
...
print(">>> After N-base filtering <<<", file=data)
