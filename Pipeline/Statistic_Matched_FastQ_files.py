...
# Date : 2020/10/11
# Author : Kaimin
# description : This is a program to check reads numbers in the FastQ file of Matched R1 R2 data.

# Target the files
import glob
import numpy as np
targetPattern_1 = r"Matched_dN*_1.fastq" 
...
targetPattern_2 = r"Matched_dN*_2.fastq" 
...
print(">>> After R1/R2 Matched <<<", file=data)
